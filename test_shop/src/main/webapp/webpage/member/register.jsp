...
<body>
	...
	<mark class="formMark">请拨打10086</mark>
	<form class="formarea">
	<ul >
    ...
    <script type="text/javascript" src="<%=basePath%>static/js/city/city.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>static/js/city/cityselect.js"></script>
</body>
</html>
